...
__conda_setup="$('/Users/taohu/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/taohu/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/taohu/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/taohu/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# Enable blinking cursor (for Termius)
echo -e "\e[?12h"
